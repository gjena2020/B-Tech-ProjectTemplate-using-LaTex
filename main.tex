...
%-----------------------------------------
\newcommand{\thesistitle}{LANE AND TRAFFIC SIGNAL DETECTION FOR AUTONOMOUS VEHICLE USING DEEP LEARNING} % Title of the Thesis, change here
\newcommand{\thesisauthora}{Shubhashish Jena  (Roll No. 16221A05A3)} % Person 1
%\newcommand{\thesisauthorb}{M Gayathri  (Roll No. 16221A0562)} % Person 2
%\newcommand{\thesisauthorc}{Ch Venkata Rajesh  (Roll No. 17225A0501)} % Person 3
%\newcommand{\thesisauthord}{D Lokesh Babu  (Roll No. 17225A0502)} % Person 4
...
\newcommand{\thesisguide}{Prof Gunamani Jena, ME Ph D} % Project Guide
\newcommand{\depthod}{Prof Gunamani Jena, ME Ph D} % Department Head
...
\usepackage[bookmarks, colorlinks=false, pdfborder={0 0 0}, pdftitle={\thesistitle}, pdfkeywords={OpenCV}]{hyperref}
...
\input{Chapter4.tex}
\input{Chapter5.tex}
\input{Screenshot.tex}

% Appendix and Code Attachments
\fontsize{10pt}{10pt}\selectfont

\begin{appendices}
\input{code_attachment.tex}
\end{appendices}
